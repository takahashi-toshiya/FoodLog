...
type FoodFormProps = {
  ...
  initialValues: FoodInputValues;
  onCancel: () => void;
  onSubmit: (value: ValidFoodInput) => Promise<void>;
  submitLabel: string;
  title: string;
};

type ValidFoodInput = Extract<
  ReturnType<typeof validateFoodInput>,
  { isValid: true }
>["value"];
...
export function FoodForm({
  ...
  const [values, setValues] = useState<FoodInputValues>(initialValues);
